...
class MediaUploaderTest extends TestCase
{
    ...
    public function test_upload_image_with_replace_policy(): void
    {
        ...
        $this->assertDatabaseHas('media_assets', ['uuid' => $asset1->uuid, 'collection' => 'avatar']);
        ...
        $this->assertDatabaseMissing('media_assets', ['uuid' => $asset1->uuid]);
        $this->assertDatabaseHas('media_assets', ['uuid' => $asset2->uuid, 'collection' => 'avatar']);
    }
